...
# Test boulder scenario with 5 seeds for all map modes: none, ascii, png

SEEDS=(12345 23456 34567 45678 56789)
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
BASE_LOG_DIR="./runs/boulder_all_maps_${TIMESTAMP}"
MAP_RADIUS=20

mkdir -p "${BASE_LOG_DIR}"

echo "================================================================================"
echo "BOULDER SCENARIO - ALL MAP MODES TEST"
...
================================================================================
BOULDER SCENARIO TEST - ${MAP_MODE^^} MAP MODE
================================================================================
Timestamp: ${TIMESTAMP}
Map mode: ${MAP_MODE}
...
agent.init()
agent.set_task('Find a new room.')
...
================================================================================
MAP MODE COMPARISON - BOULDER SCENARIO
================================================================================
Timestamp: ${TIMESTAMP}
Seeds tested: ${SEEDS[*]}
Map radius: ${MAP_RADIUS}
