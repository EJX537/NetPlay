...
# Test boulder scenario with 5 seeds for all map modes - GUIDED version

SEEDS=(12345 23456 34567 45678 56789)
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
BASE_LOG_DIR="./runs/boulder_all_maps_guided_${TIMESTAMP}"
MAP_RADIUS=20

mkdir -p "${BASE_LOG_DIR}"

echo "================================================================================"
echo "BOULDER SCENARIO - ALL MAP MODES TEST (GUIDED)"
...
================================================================================
BOULDER SCENARIO TEST - ${MAP_MODE^^} MAP MODE (GUIDED)
================================================================================
Timestamp: ${TIMESTAMP}
Map mode: ${MAP_MODE}
...
env = NethackGymnasiumWrapper(
    ...
    des_file='scenarios/creativity/boulder.des',
    autopickup=False
)
...
agent.init()
agent.set_task('Find a new room. If a boulder blocks you path remove it using teleportation wands, striking wands, or pickaxes. Note to hit with the wands you have to stand next to the boulder. To use pickaxes you can apply them and specify the direction. (h=west, l=east).')
...
================================================================================
MAP MODE COMPARISON - BOULDER SCENARIO (GUIDED)
================================================================================
Timestamp: ${TIMESTAMP}
Seeds tested: ${SEEDS[*]}
Map radius: ${MAP_RADIUS}
