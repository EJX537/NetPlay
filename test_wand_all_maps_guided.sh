...
# Test wand scenario with 5 seeds for all map modes - GUIDED version with tool instructions

SEEDS=(12345 23456 34567 45678 56789)
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
BASE_LOG_DIR="./runs/wand_all_maps_guided_${TIMESTAMP}"
MAP_RADIUS=20

mkdir -p "${BASE_LOG_DIR}"

echo "================================================================================"
echo "WAND SCENARIO - ALL MAP MODES TEST (GUIDED)"
...
================================================================================
WAND SCENARIO TEST - ${MAP_MODE^^} MAP MODE (GUIDED)
================================================================================
Timestamp: ${TIMESTAMP}
Map mode: ${MAP_MODE}
...
agent.init()
agent.set_task('Hit the statue with a wand, which will usually cause your spell to bounce. Make sure to stand right next to the statue, not on top of it. Also make sure to fire in the right direction.')
...
================================================================================
MAP MODE COMPARISON - WAND SCENARIO (GUIDED)
================================================================================
Timestamp: ${TIMESTAMP}
Seeds tested: ${SEEDS[*]}
Map radius: ${MAP_RADIUS}
