...
# Test escape scenario with 5 seeds for all map modes: none, ascii, png

SEEDS=(12345 23456 34567 45678 56789)
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
BASE_LOG_DIR="./runs/escape_all_maps_${TIMESTAMP}"
MAP_RADIUS=20

mkdir -p "${BASE_LOG_DIR}"

echo "================================================================================"
echo "ESCAPE SCENARIO - ALL MAP MODES TEST"
...
================================================================================
ESCAPE SCENARIO TEST - ${MAP_MODE^^} MAP MODE
================================================================================
Timestamp: ${TIMESTAMP}
Map mode: ${MAP_MODE}
...
env = NethackGymnasiumWrapper(
    ...
    des_file='scenarios/creativity/escape.des',
    autopickup=False
)
...
================================================================================
MAP MODE COMPARISON - ESCAPE SCENARIO
================================================================================
Timestamp: ${TIMESTAMP}
Seeds tested: ${SEEDS[*]}
Map radius: ${MAP_RADIUS}
